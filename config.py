...
D.meta_sr_c_dim = 3
D.model = 'metaSR'   # RDN for train RDN model, else train meta-SR model
# D.model = 'RDN'
D.mode = 'predict'  # train or predict the model, use predict to predict the model
# D.mode = 'predict'
D.model_dir = './models_metaSR_v3'
# D.model_dir = './models_v3'
